  ...
  return (
    <div
      style={{
        ...
        borderRadius: "16px",
        padding: "20px 22px",
        boxShadow: "0 2px 10px rgba(0,59,185,0.06)",
        cursor: "default",
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 6px 20px rgba(0,59,185,0.11)";
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 2px 10px rgba(0,59,185,0.06)";
      }}
    >
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", minHeight: "72px" }}>
        ...
        <div style={{ marginTop: "14px" }}>
          ...
          {(subtitle || changeLabel) && (
            <div style={{ fontSize: "11px", color: "rgba(0,59,185,0.4)", marginTop: "3px" }}>{subtitle || changeLabel}</div>
          )}
        </div>
      </div>
        ...
        {change !== undefined ? (
          ...
          >
            {change > 0 ? (
              ...
              <Minus size={11} style={{ marginRight: "3px" }} />
            )}
            {Math.abs(change)}%
          </span>
        ) : (
