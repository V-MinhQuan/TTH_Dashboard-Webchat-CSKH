    ...
    def batch_count_all_stats(
        ...
        inner_query = f\"\"\"
            SELECT 
                ...
                CASE WHEN a.aiStatus = 'failed' THEN 1 ELSE 0 END AS is_failed
...
if "def batch_count_all_stats" not in content:
    content = content.replace("def count_cooccurrence", new_method + "\n    def count_cooccurrence")
    
    with open(target_file, "w", encoding="utf-8") as f:
        f.write(content)
    print("Method batch_count_all_stats inserted successfully.")
else:
